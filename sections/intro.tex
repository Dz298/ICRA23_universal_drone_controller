...
The second half of the last paragraph discussing alternate
methods should be moved to the related work section of this
paper.}
...
%
\todo{The introduction indicates that the controller is able to
adapt to new situations within 0.8 sec (which corresponds
to the window of 400 steps). But in Section V.C, empirical
results indicate that the adaptation period is close to 2
secs.}
%
...
%
\todo{When the authors enumerate the three insights leveraged by
their algorithm, the third comment about the algorithm
being robust to disturbances within the convex hull of the
training should be substantiated. }
%
